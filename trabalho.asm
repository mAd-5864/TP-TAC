...
GET_BOARD_DONE:
                    goto_xy            bl,al                                        ; Mover o cursor para o tabuleiro correto
                    ret
GET_BOARD           endp
...
CHECK_WIN           PROC
                    ...
                    jmp                winNotFound                                  ; If the loop completes without finding a win, handle accordingly
...
checkDiagonals:
    ; Add diagonal checks here

winNotFound:
    ; Handle case when no win is found
    ; ...
